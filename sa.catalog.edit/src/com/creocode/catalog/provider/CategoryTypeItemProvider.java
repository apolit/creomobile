...
/**
 * This is the item provider adapter for a {@link com.creocode.catalog.CategoryType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CategoryTypeItemProvider
	 ...
	 * @generated
	 */
	public CategoryTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CatalogPackage.Literals.CATEGORY_TYPE__ITEM);
			childrenFeatures.add(CatalogPackage.Literals.CATEGORY_TYPE__SUB_CATEGORY);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CategoryType"));
	}
	...
	public String getText(Object object) {
		String label = ((CategoryType)object).getTitle();
		return label == null || label.length() == 0 ?
			getString("_UI_CategoryType_type") :
			getString("_UI_CategoryType_type") + " (" + label + ")";
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CatalogPackage.Literals.CATEGORY_TYPE__ITEM,
				 CatalogFactory.eINSTANCE.createItemType()));

		newChildDescriptors.add
			(createChildParameter
				(CatalogPackage.Literals.CATEGORY_TYPE__SUB_CATEGORY,
