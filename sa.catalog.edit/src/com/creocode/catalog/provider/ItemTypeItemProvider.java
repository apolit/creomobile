...
/**
 * This is the item provider adapter for a {@link com.creocode.catalog.ItemType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ItemTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ItemType_itemIdentifier_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ItemType_itemIdentifier_feature", "_UI_ItemType_type"),
				 CatalogPackage.Literals.ITEM_TYPE__ITEM_IDENTIFIER,
				 true,
				 false,
				 false,
	...
	protected void addTitlePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ItemType_title_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ItemType_title_feature", "_UI_ItemType_type"),
				 CatalogPackage.Literals.ITEM_TYPE__TITLE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addContentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ItemType_content_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ItemType_content_feature", "_UI_ItemType_type"),
				 CatalogPackage.Literals.ITEM_TYPE__CONTENT,
				 true,
				 true,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Intro feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIntroPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ItemType_intro_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ItemType_intro_feature", "_UI_ItemType_type"),
				 CatalogPackage.Literals.ITEM_TYPE__INTRO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CatalogPackage.Literals.ITEM_TYPE__DETAILS);
		}
	...
	public String getText(Object object) {
		String label = ((ItemType)object).getTitle();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CatalogPackage.Literals.ITEM_TYPE__DETAILS,
				 CatalogFactory.eINSTANCE.createDetailsType()));
	}
